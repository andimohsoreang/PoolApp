            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row d-flex justify-content-center">
                        ...
                        <!--end col-->
                        <div class="col align-self-center">
                            <img src="{{ asset('dist/assets/images/extra/tree.png') }}" alt="" class="img-fluid">
                        </div>
                        <!--end col-->
                    </div>
                    <!--end row-->
                        ...
                        <div class="col-auto">
                            <div class="img-group d-flex">
                                <a class="user-avatar position-relative d-inline-block" href="#">
                                    <img src="{{ asset('dist/assets/images/users/avatar-1.jpg') }}" alt="avatar"
                                        class="thumb-md shadow-sm rounded-circle">
                                </a>
                                <a class="user-avatar position-relative d-inline-block ms-n2" href="#">
                                    <img src="{{ asset('dist/assets/images/users/avatar-2.jpg') }}" alt="avatar"
                                        class="thumb-md shadow-sm rounded-circle">
                                </a>
                                <a class="user-avatar position-relative d-inline-block ms-n2" href="#">
                                    <img src="{{ asset('dist/assets/images/users/avatar-4.jpg') }}" alt="avatar"
                                        class="thumb-md shadow-sm rounded-circle">
                                </a>
                                <a class="user-avatar position-relative d-inline-block ms-n2" href="#">
                                    <img src="{{ asset('dist/assets/images/users/avatar-3.jpg') }}" alt="avatar"
                                        class="thumb-md shadow-sm rounded-circle">
                                </a>
                        ...
                        <table class="table mb-0">
                            <tbody>
                                <tr class="">
                                    <td class="px-0">
                                        <div class="d-flex align-items-center">
                                            <img src="dist/assets/images/flags/us_flag.jpg"
                                ...
                                <tr class="">
                                    <td class="px-0">
                                        <div class="d-flex align-items-center">
                                            <img src="dist/assets/images/flags/spain_flag.jpg"
                                                class="me-2 align-self-center thumb-md rounded" alt="...">
                                            <div class="flex-grow-1 text-truncate">
                                ...
                                <tr class="">
                                    <td class="px-0">
                                        <div class="d-flex align-items-center">
                                            <img src="dist/assets/images/flags/french_flag.jpg"
                                                class="me-2 align-self-center thumb-md rounded" alt="...">
                                            <div class="flex-grow-1 text-truncate">
                                ...
                                <tr class="">
                                    <td class="px-0">
                                        <div class="d-flex align-items-center">
                                            <img src="dist/assets/images/flags/germany_flag.jpg"
                                                class="me-2 align-self-center thumb-md rounded" alt="...">
                                            <div class="flex-grow-1 text-truncate">
                                ...
                                <tr class="">
                                    <td class="px-0">
                                        <div class="d-flex align-items-center">
                                            <img src="dist/assets/images/flags/baha_flag.jpg"
                                                class="me-2 align-self-center thumb-md rounded" alt="...">
                                            <div class="flex-grow-1 text-truncate">
                                ...
                                <tr class="">
                                    <td class="px-0">
                                        <div class="d-flex align-items-center">
                                            <img src="dist/assets/images/flags/russia_flag.jpg"
                                                class="me-2 align-self-center thumb-md rounded" alt="...">
                                            <div class="flex-grow-1 text-truncate">
                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="dist/assets/images/products/01.png" height="40"
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="dist/assets/images/products/02.png" height="40"
                                                class="me-3 align-self-center rounded" alt="...">
                                            <div class="flex-grow-1 text-truncate">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="dist/assets/images/products/04.png" height="40"
                                                class="me-3 align-self-center rounded" alt="...">
                                            <div class="flex-grow-1 text-truncate">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="dist/assets/images/products/06.png" height="40"
                                                class="me-3 align-self-center rounded" alt="...">
                                            <div class="flex-grow-1 text-truncate">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <img src="{{ asset('dist/assets/images/products/05.png') }}" height="40"
                                                class="me-3 align-self-center rounded" alt="...">
                                            <div class="flex-grow-1 text-truncate">
