        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Formulir Tambah Customer</h4>
                </div>
                <div class="card-body">
                    <!-- Alert Messages -->
                    @if(session('error'))
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('category') is-invalid @enderror" id="category" name="category" required>
                                                ...
                                                <option value="non_member" {{ old('category') == 'non_member' ? 'selected' : '' }}>Non-Member</option>
                                            </select>
                                            @error('category')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('current_address') is-invalid @enderror" id="current_address" name="current_address" rows="3">{{ old('current_address') }}</textarea>
                                        ...
                                        <div class="mb-0">
                                            ...
                                            <textarea class="form-control @error('origin_address') is-invalid @enderror" id="origin_address" name="origin_address" rows="3">{{ old('origin_address') }}</textarea>
