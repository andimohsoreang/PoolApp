...
@section('title', 'Edit Manual Notification')
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Edit Manual Notification</h4>
            </div>
        </div>
    </div>
                    ...
                    <form action="{{ route('admin.notifications.update', $notification->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="type" id="type" class="form-select" required>
                                ...
                                <option value="reservation" {{ $notification->type == 'reservation' ? 'selected' : '' }}>Reservation</option>
                                ...
                                <option value="other" {{ $notification->type == 'other' ? 'selected' : '' }}>Other</option>
                            </select>
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('admin.notifications.show', $notification->id) }}" class="btn btn-outline-secondary">
                                <i class="iconoir-arrow-left me-1"></i> Back
                            </a>
                            <button type="submit" class="btn btn-primary">
                                <i class="iconoir-save-floppy me-1"></i> Update Notification
                            </button>
                        </div>
                    </form>
                </div>
